...
int __stdcall MessageHookProc(int nCode, WPARAM wparam, LPARAM lparam) {
	...
	if (nCode == HC_ACTION) 
	{
		...
		{
			//System::String^ local = System::Runtime::InteropServices::Marshal::PtrToStringUni( msg->wParam);
			wchar_t* acmRemote = (wchar_t*)msg->wParam;
			//System::String^ acmLocal = System::String::Format("{0}", (System::IntPtr)acmRemote));
