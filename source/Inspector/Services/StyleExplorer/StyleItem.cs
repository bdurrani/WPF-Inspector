...
namespace ChristianMoser.WpfInspector.Services.StyleExplorer
{
    ...
    public class StyleItem : IDisposable
    {
        ...
        private readonly List<EventSetterItem> _eventSetterItems = new List<EventSetterItem>();
        ...
        public StyleItem(Style style, FrameworkElement source, string name, string location, StyleScope scope)
        {
            ...
            foreach (SetterBase setterBase in style.Setters)
            {
                ...
                var eventSetter = setterBase as EventSetter;
                if (eventSetter != null)
                {
                    _eventSetterItems.Add(new EventSetterItem(eventSetter.Event.ToString(), eventSetter.Handler.ToString()));
                }
            }
        ...
        /// Gets the setter items.
        /// </summary>
        public List<EventSetterItem> EventSetterItems
        {
            get { return _eventSetterItems; }
        }
